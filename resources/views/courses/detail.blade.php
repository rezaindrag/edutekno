            ...
            <div class="row">
                <div class="col-md-8 py-5">
                    ...
                    <p class="m-0 text-light" style="font-size: 15px">
                        <span class="text-light">Instruktur:</span> <a href="" class="text-primary">{{ $course->instructor->name }}</a></span>
                ...
                <div class="col-md-4" style="position: absolute;top: 48px;right: 0;z-index: 99">
                    <div class="d-flex flex-column mb-2">
                        <a href="{{ url('preview/'.$course->slug.'/'.$course->lessons[0]->slug.'/'.$course->lessons[0]->videos[0]->slug) }}" class="card card-group-top">
                        ...
                        <div class="card card-group-bottom">
                            <div class="card-body bg-light">
                                @if($course->price == 0)
                                    <h5 class="text-center text-dark pt-2 pb-3">Free</h5>
                                    <a href="" class="btn btn-outline-primary btn-block btn-lg">Enroll</a>
                                @else
                                    <h5 class="text-center text-dark pt-2 pb-3">IDR {{ number_format($course->price, 0, ",", ".") }}</h5>
                                    <a href="" class="btn btn-outline-primary btn-block btn-lg">Buy Now</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="list-group list-group-flush d-flex flex-row flex-wrap justify-content-between">
                                @foreach($course->subjects as $subject)
                                    <li class="list-group-item col-6 border-0 px-0 pt-0 pb-1">
                                        <span><i class="fa fa-check text-primary mr-2"></i> {{ $subject }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="lesson{{ $i }}" class="collapse show">
                                        ...
                                        @foreach($lesson->videos as $video)
                                            <ul class="list-group list-group-flush">
                                                <li href="" class="list-group-item border-top-0 px-0 py-2 d-flex flex-row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-9">
                                ...
                                @if ($course->instructor->web)
                                    <p class="mb-0"><a href="" class="text-primary"><i class="fa fa-link"></i> {{ $course->instructor->web }}</a></p>
                                @endif
                                @if ($course->instructor->facebook)
                                    <p class="mb-0"><a href="" class="text-primary"><i class="fab fa-facebook"></i> {{ $course->instructor->facebook }}</a></p>
                                @endif
                                @if ($course->instructor->twitter)
                                    <p class="mb-0"><a href="" class="text-primary"><i class="fab fa-twitter"></i> {{ $course->instructor->twitter }}</a></p>
                                @endif
                                @if ($course->instructor->linkedin)
                                    <p class="mb-0"><a href="" class="text-primary"><i class="fab fa-linkedin"></i> {{ $course->instructor->linkedin }}</a></p>
                                @endif
                            </div>
                        </div>
                    </div>

<nav class="navbar navbar-expand-lg navbar-light bg-white">
	<div class="container">
		<a class="navbar-brand logo text-success" href="/">edutekno</a>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="#">Mobile Developer</a>
					</div>
				</li>
				<li class="nav-item">
				...
				@guest
					<li class="nav-item ml-3 d-flex justify-content-center align-items-center">
						<a class="nav-link p-0" href="{{ url('login') }}">
							<button class="btn btn-outline-success py-1 px-2">Login</button>
						</a>
						<a class="nav-link p-0 ml-2" href="{{ url('register') }}">
							<button class="btn btn-success py-1 px-2">Daftar</button>
						</a>
					</li>
				@endguest
				@auth

<nav class="col-md-3 d-none d-md-block bg-light p-0 sidebar">
  <div class="sidebar-stick">
    <div class="card list-contents">
      ...
      <div class="card-body p-0 py-2">
        ...
        <div id="accordion">
          ...
          <div class="card rounded-0 border-1 border-0 pt-2">
            <div class="card-header bg-white rounded-0 border-0 p-0" id="heading<?php echo $o ?>" data-toggle="collapse" data-target="#collapse<?php echo $o ?>" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div class="list-group list-group-flush p-0" id="list-group">
                  <?php for ($i = 0; $i < 3; $i++) { ?>
                    <a href="" class="list-group-item py-2 px-3 video-item d-flex align-items-start flex-direction-row">
                      <span class="play-icon text-dark" style="width: 30px">
                        <i class="far fa-play-circle"></i>
                      </span> 
                      <span class="video-title text-dark" style="flex: 1">
                        Dapibus ac facilisis in Dapibus ac facilisis
                      </span>
                      <span class="video-title text-secondary" style="width: 40px">10.23</span>
                    </a>
                  <?php } ?>
                </div>
                <!-- List Item -->
      ...
      <!-- <div class="card-footer bg-white">@ <?php // echo date('Y') ?> GuruCoding.id</div> -->
    </div>
  </div>
</nav>

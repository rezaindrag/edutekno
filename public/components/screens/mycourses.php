<div class="row filter">
	<div class="col-md-12 d-flex flex-row justify-content-between">
		<div class="d-flex flex-row justify-content-between">
			<div class="mr-3">
				<span class="title-attrs text-secondary">Urut Berdasarkan</span>
				<div class="dropdown show">
					<a class="btn btn-outline-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Terakhir Diakses
					</a>
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<a class="dropdown-item" href="#">Judul: A-Z</a>
						<a class="dropdown-item" href="#">Judul: Z-A</a>
						<a class="dropdown-item" href="#">Progress: 0%-100%</a>
						<a class="dropdown-item" href="#">Progress: 100%-0%</a>
					</div>
				</div>
			</div>
			<div class="mr-2">
				<span class="title-attrs text-secondary">Filter Berdasarkan</span>
				<div class="d-flex flex-row justify-content-between">
